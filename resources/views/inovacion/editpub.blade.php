...
<div class="row ">
<div class="col-md-6">
{!!Form::open(['route' => ['inovacion.publicacion.update',$publicacion->id], 'method'=>'PUT','accept-charset'=>'UTF-8','enctype'=>'multipart/form-data','files'=>'true','class'=>'form-horizontal'] )!!}
