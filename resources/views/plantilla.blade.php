				...
				<!-- Encabezado -->
					<div class="row">
						<div class="col-sm-4 img-responsive" alt="Responsive image"> 
	    					<a href="{{asset('Inicio')}}"><img src="{{asset('img/logo_cozcyt.png')}}" class="img-responsive" alt="Responsive image"></a>
	    				</div>
                    ...
                    <nav class="navbar navbar-default" >		    			   
				      	...
				      	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						    <ul class="nav navbar-nav">
						        ...
						        <li class="dropdown active">
							        <a class="dropdown-toggle" data-toggle="dropdown" href="#">COZCyT
							            <span class="caret"></span></a>
											...
											<li><a href="{{asset('doc/MANUAL DE ORGANIZACION 2014.pdf')}}" target="_blank">Normatividad</a></li>									          	
							        ...
							        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Desarrollo Talento
							           <span class="caret"></span></a>
							        		<ul class="dropdown-menu">
							        			...
							        			<li><a href="{{url('doc/becasextr.pdf')}}" target="_blank">Becas al Extranjero</a></li>
								...
								<li class="dropdown">
							        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Quantum          <span class="caret"></span></a>
