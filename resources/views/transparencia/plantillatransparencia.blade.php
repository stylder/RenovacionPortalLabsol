       ...
       <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="{{asset('transparencia/transparencia')}}">Inicio</a></li>
                  
                  <li><a href="{{asset('transparencia/publicacion')}}">Crear Publicación</a></li>
                  <li><a href="{{asset('transparencia/subirimagen')}}">Cargar Imágenes</a></li>
                  <li><a href="{{asset('transparencia/publicaciones')}}">Publicaciones</a></li>
                    <?php if (Auth::user()):?> 
