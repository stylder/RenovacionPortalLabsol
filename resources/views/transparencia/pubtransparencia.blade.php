...
<div class="col-md-6">
          <form class="form-horizontal" method="POST" action="Pub/create" accept-charset="UTF-8" enctype="multipart/form-data" files="true">
            ...
            <div class="form-group">
                  <label class="col-md-4 control-label" for="article_imagen">imagen de portada</label>  
                    <div class="col-md-4">
                        ...
                        <input type="file" class="form-control" name="file" accept="image/jpeg,png,jpg" required required data-toggle="tooltip" data-placement="right" title="selecciona una imagen para para que sea la imagen que aparesca como portada de la publicación" >
            ...
            <div class="form-group">
            <label class=" control-label" for="article_categories" data-toggle="tooltip" data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal" data-toggle="tooltip" data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal">Slider</label>    
