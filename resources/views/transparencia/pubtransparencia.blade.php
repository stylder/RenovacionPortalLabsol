...
@section('contenido')
    <div class="row ">
        <div class="col-md-6">
            <form class="form-horizontal" method="POST" action="Pub/create" accept-charset="UTF-8"
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="article_url" name="article_autor" type="text" placeholder="Autor"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="article_title" name="article_titulo" type="text"
                                           placeholder="Titulo del Articulo" class="form-control input-md" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="file" class="form-control" name="file" accept="image/jpeg,png,jpg"
                                           required required data-toggle="tooltip" data-placement="right"
                                           title="selecciona una imagen para para que sea la imagen que aparesca como portada de la publicación">
                            ...
                            <div class="form-group">
                                <label class=" control-label" for="article_categories" data-toggle="tooltip"
                                       data-placement="right"
                                       title="hace que aparesca la publicación en el slider de la pagina principal"
                                       data-toggle="tooltip" data-placement="right"
                                       title="hace que aparesca la publicación en el slider de la pagina principal">Slider</label>
                ...
                <textarea class="tinymce" name="contenido">
                        ...
                        <div class="row">
                            <button class="btn btn-default" type="submit" data-toggle="tooltip" data-placement="left"
                                    title="guarda la publicación">Publicar
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="main_area">
                        ...
                        <ul class="hide-bullets">
                            ...
                            <li class="col-sm-3 ima">
                                <a class="thumbnail" id="carousel-selector-15"><img class="img-responsive imag"
                                                                                    src="{{asset('/uploads/').'/'.$imagen->url }}"></a>
                            </li>
                            <?php endforeach ?>
                        </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="hi" name="article_titulo" type="text" placeholder="Url de la imágen......"
                                       class="form-control input-md">

                                <button id="copi" onclick="copiar('hi')" class="btn btn-primary" data-toggle="tooltip"
                                        data-placement="left" title="copea la url de la imagen seleccionada">Copiar la
                                    URL
                                </button>
