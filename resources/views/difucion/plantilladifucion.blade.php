       ...
       <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="{{asset('difucion/difucion')}}">Inicio</a></li>
                  
                  <li><a href="{{asset('difucion/publicacion')}}">Crear Publicación</a></li>
                  <li><a href="{{asset('difucion/subirimagen')}}">Cargar Imágenes</a></li>
                  <li><a href="{{asset('difucion/revista')}}">Crear Revista</a></li>
                  <li><a href="{{asset('difucion/publicaciones')}}">Publicaciones</a></li>
                    <?php if (Auth::user()):?> 
