...
<div class="row ">
<div class="col-md-6">
{!!Form::open(['route' => ['cecodic.publicacion.update',$publicacion->id], 'method'=>'PUT','accept-charset'=>'UTF-8','enctype'=>'multipart/form-data','files'=>'true','class'=>'form-horizontal'] )!!}
            ...
            <div  class="  col-md-4 " >
                        ...
                        <input type="file" class="form-control" name="file" required accept="image/jpg,png,jpeg" data-toggle="tooltip" data-placement="right" title="selecciona una imagen para para que sea la imagen que aparesca como portada de la publicación"> 
            ...
            <div class="form-group">
            <label class=" control-label" for="article_categories" data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal">Slider</label> 
            	@if ($publicacion->importante == 1)
                <input type="checkbox" name="importante" value="1" checked data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal">
                @else
                <input type="checkbox" name="importante" value="1" data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal" >
              @endif
            </div>
            ...
            <div class="row">
            <button class="btn btn-default" type="submit" data-placement="left" title="guarda la publicación">Publicar</button>
            </div>
                      </div>
      </div>
