       ...
       <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="{{asset('cecodic/cecodic')}}">Inicio</a></li>
                  
                  <li><a href="{{asset('cecodic/publicacion')}}">Crear Publicación</a></li>
                  <li><a href="{{asset('cecodic/subirimagen')}}">Cargar Imágenes</a></li>
                  <li><a href="{{asset('cecodic/publicaciones')}}">Publicaciones</a></li>
                    <?php if (Auth::user()):?> 
