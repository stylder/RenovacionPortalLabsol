       ...
       <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="{{asset('DT/DT')}}">Inicio</a></li>
                  
                  <li><a href="{{asset('DT/publicacion')}}">Crear Publicación</a></li>
                  <li><a href="{{asset('DT/subirimagen')}}">Cargar Imágenes</a></li>
                  <li><a href="{{asset('DT/publicaciones')}}">Publicaciones</a></li>
                    <?php if (Auth::user()):?> 
