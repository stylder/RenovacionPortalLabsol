...
<div class="col-md-6">
          <form class="form-horizontal" method="POST" action="Pub/create" accept-charset="UTF-8" enctype="multipart/form-data" files="true">
            ...
            <input type="checkbox" name="vehicle" value="Car" data-toggle="tooltip" data-placement="right" title="hace que aparesca la publicación en el slider de la pagina principal">
            </div>
