...
<div class="col-md-6">
          <form class="form-horizontal" method="POST" action="Pub/create" accept-charset="UTF-8" enctype="multipart/form-data" files="true">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
             <input id="article_url" name="article_autor" type="text" placeholder="Autor" value="{{Auth::user()->name}}" readonly="readonly" class="form-control input-md" >
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="article_title" name="article_titulo" type="text" placeholder="Titulo del Articulo" class="form-control input-md">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select id="article_categories" name="seccion" class="form-control">
