...
<html lang="en">
  <head>
    ...
    <link href="{{asset('bootstrap/css/estilos.css')}}" rel="stylesheet">
     @yield('css')
       ...
       <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="{{asset('admin/administrador')}}">Inicio</a></li>

                  <li><a href="{{asset('admin/crearusuario')}}">Crear Usuario</a></li>

                  <li><a href="{{asset('admin/publicacion')}}">Crear Publicación</a></li>
                  <li><a href="{{asset('admin/subirimagen')}}">Cargar Imágenes</a></li>
                  
                  <li><a href="{{asset('admin/usuarios')}}">Usuarios</a></li>
                    <li><a href="{{asset('admin/publicaciones')}}">Publicaciones</a></li>
                    <?php if (Auth::user()):?> 
