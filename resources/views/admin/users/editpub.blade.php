...
<div class="row ">
<div class="col-md-6">
{!!Form::open(['route' => ['admin.publicacion.update',$publicacion->id], 'method'=>'PUT','accept-charset'=>'UTF-8','enctype'=>'multipart/form-data','files'=>'true','class'=>'form-horizontal'] )!!}
            ...
            <div  class="  col-md-4 " >
                        ...
                        <input type="file" class="form-control" name="file" required accept="image/jpg,png,jpeg" > 
            ...
            <div class="form-group">
            <label class=" control-label" for="article_categories" data-toggle="tooltip" data-placement="left" title="hace que aparesca la publicación en el slider de la pagina principal">Slider</label> 
            	@if ($publicacion->importante == 1)
                <input type="checkbox" name="importante" value="1" checked >
                @else
